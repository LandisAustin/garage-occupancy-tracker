...
// --------------------
#define Web_API_KEY "FIREBASE_API_KEY"
#define DATABASE_URL "FIREBASE_DB_URL"
#define USER_EMAIL "AUTHENTICATED_USER_EMAIL"
#define USER_PASS "AUTHENTICATED_USER_PASSWORD"
